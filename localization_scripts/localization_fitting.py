...
def localize_joint_poisson(
    ...
    for row_id in range(len(rois_list)):
        ...
        localizations[row_id] = (
            ...
            int(_roi_value(roi_record, "segmentation_id", 0)),
            int(_roi_value(roi_record, "parent_seed_peak_us", 0)),
            int(_roi_value(roi_record, "parent_seed_x", 0)),
            int(_roi_value(roi_record, "parent_seed_y", 0)),
            int(_roi_value(roi_record, "t_on_window_start", 0)),
            int(_roi_value(roi_record, "t_on_window_stop", 0)),
            int(_roi_value(roi_record, "t_off_window_start", 0)),
            int(_roi_value(roi_record, "t_off_window_stop", 0)),
            int(_roi_value(roi_record, "t_on_first", 0)),
            int(_roi_value(roi_record, "t_on_last", 0)),
            int(_roi_value(roi_record, "t_off_first", 0)),
            int(_roi_value(roi_record, "t_off_last", 0)),
            int(_roi_value(roi_record, "quiet_dwell_us", 0)),
            int(_roi_value(roi_record, "endpoint_overlap_us", 0)),
            int(_roi_value(roi_record, "cycle_span_us", 0)),
            float(_roi_value(roi_record, "pair_score", np.nan)),
            float(_roi_value(roi_record, "pair_centroid_distance_px", np.nan)),
            float(_roi_value(roi_record, "on_core_density_ratio", np.nan)),
            float(_roi_value(roi_record, "off_core_density_ratio", np.nan)),
            int(_roi_value(roi_record, "on_core_events", 0)),
            int(_roi_value(roi_record, "off_core_events", 0)),
            int(_roi_value(roi_record, "on_active_pixels", 0)),
            int(_roi_value(roi_record, "off_active_pixels", 0)),
            float(_roi_value(roi_record, "temporal_center_x", np.nan)),
            float(_roi_value(roi_record, "temporal_center_y", np.nan)),
        )
...
def _joint_poisson_localization_dtype(roi_rad: int) -> list[tuple]:
    ...
    return [
        ...
        ("parent_seed_x", np.uint16),
        ("parent_seed_y", np.uint16),
